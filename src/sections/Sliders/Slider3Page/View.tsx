                ...
                <div className={styles.imagesContainer}>
                    <div className={styles.imagesContainerFirst}>
                        <div className={styles.itemImageRight}>
                            ...
                            <Image width={240} height={240} alt='' className={styles.image} src={'../images/slider3/view/1.png'}/>
                        </div>
                        ...
                        <div className={styles.itemImageRight}>
                            ...
                            <Image width={240} height={240} alt='' className={styles.image} src={'../images/slider3/view/2.png'}/>
                        </div>
                    </div>

                    <div className={styles.imagesContainerSecond}>
                        <div className={styles.itemImageLeft}>
                            <Image width={240} height={240} alt='' className={styles.image} src={'../images/slider3/view/3.png'}/>
                        ...
                        <div className={styles.itemImageLeft}>
                            <Image width={240} height={240} alt='' className={styles.image} src={'../images/slider3/view/4.png'}/>
