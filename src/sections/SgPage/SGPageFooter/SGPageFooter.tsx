...
import {XtremeTuner} from "./XtremeTuner/XtremeTuner";
import Image from "next/image";
import {Dlss} from "./Dlss/Dlss";
...
export const SGPageFooter = ({className, classNameBox, color, classNameFill}: XPageFooterProps) => {
    return (
        <section className={`${cls.section} ${color}`}>
            <XtremeTuner deep={true} black={classNameFill} classNameBox={cls.boxColor}/>
